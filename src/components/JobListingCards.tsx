        ...
        {jobs.map((job) => (
          ...
          >
            ...
            <div className="mt-5 flex items-center justify-between">
              {/* Left side: price */}
              <h2 className="text-lg font-semibold text-black">$900/hr</h2>
...
"
      ...
      {selectedJob && (
        <div className="fixed inset-0 z-50 flex items-end bg-black/50">
          <div
            className={`bg-white w-full mr-2 ml-2 min-h-[80vh] max-h-[85vh] rounded-t-2xl border-t border-black p-6 pb-10 overflow-y-auto
                            ${
                              isClosing
                                ? "animate-slideDown"
                                : "animate-slideUp"
          ...
          >
            ...
            <section className="mb-8">
              ...
              <p className="text-black leading-relaxed">{selectedJob.brief}</p>
            </section>
